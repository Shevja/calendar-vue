...
### Реализация календаря в виде компонента при помощи Vue 3.
Функционал: 
- Возможность передавать в компонент календаря дату в формате "YYYY-MM-DD", если дата не будет передана, компонент установит дату сегодняшнего дня.
...
# Calendar
### Implementation of a calendar as a Vue 3 component.

Features:
- Ability to pass a date to the calendar component in the "YYYY-MM-DD" format; if no date is provided, the component will default to today's date.
